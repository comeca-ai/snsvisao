...
export function PureMessageActions({
  ...
  const handleCopy = useCallback(async () => {
    if (!textFromParts) {
      toast.error("Não tem texto para copiar!");
      return;
    }
  ...
  const handleUpvote = useCallback(() => {
    ...
    toast.promise(upvote, {
      error: "Não consegui registrar. Tenta de novo?",
      loading: "Registrando...",
      success: () => {
        mutate<Vote[]>(
